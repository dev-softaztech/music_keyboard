...
/// Listens for incoming deep links (sheet shares, Firebase Auth action links)
/// and navigates to the right screen once resolved.
///
/// Navigation to a resolved [Sheet] is delegated to [onNavigateToSheet],
/// registered by `app.dart`, so this class never imports screen widgets
/// directly.
class DeepLinkHandler {
  ...
  /// Registered by `app.dart` to navigate to the keyboard screen with a
  /// resolved sheet, without this class needing to import screen widgets.
  static void Function(BuildContext context, Sheet sheet)? onNavigateToSheet;
    ...
    try {
      ...
      WidgetsBinding.instance.addPostFrameCallback((_) {
        ...
        if (sheet != null) {
          ...
          onNavigateToSheet?.call(navigatorContext, sheet);
